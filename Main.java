...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        print(Algies.alphaSelection(new String[]{"1", "2","4","6","3","9","2","5","9"})); //tested to see if numbers as strings work (it does)
        System.out.println();
        ...
        printArrList(Algies.alphaSelection(new ArrayList<>(Arrays.asList("1", "2","4","6","3","9","2","5","9")))); //tested to see if numbers as strings work (it does)
...
//      --------------------------------------------------------------------------------
        ...
        String[] str3 = {"cat","rat","bat", "jholmer"}; String[] s3 = a.insertionSort(str3);
...
//      // ArrayList with insertion sort
        ...
        ArrayList<String> aL2 = new ArrayList<String>(Arrays.asList("Zebra","alpha","map","jholmer")); aL2 = a.insertionSortButForAL(aL2);
